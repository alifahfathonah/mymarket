                                    ...
                                    <div class="card mycard h-100 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            <div class="clearfix mb-3">
                                                <span class="float-start badge rounded-pill bg-success">Rp&nbsp;{{number_format($row->harga,0,",",".")}}</span>
                                            </div>
                                            <h5 class="card-title">
                                                {{$row->deskripsi}}
                                            </h5>
                                            ...
                                            <div class="d-grid gap-2 my-4 mt-2">
                                                <form action="{{route('user.savebelanja')}}" method="post">
                                                    ...
                                                    <button type="submit" class="btn btn-warning bold-btn">add to cart</button>
                                                </form>
